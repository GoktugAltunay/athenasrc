...
/*    */ 
/*    */ @Tag
/*    */ public class ProcedureNitroxinRightClickedInAir
/*    */   extends ElementsFinfinMod.ModElement {
/*    */   public ProcedureNitroxinRightClickedInAir(ElementsFinfinMod instance) {
/* 24 */     super(instance, 25);
/*    */   }
/*    */   
/*    */   public static void executeProcedure(Map<String, Object> dependencies) {
/* 28 */     if (dependencies.get("entity") == null) {
/* 29 */       System.err.println("Failed to load dependency entity for procedure NitroxinRightClickedInAir!");
/*    */       return;
/*    */     } 
/* 32 */     Entity entity = (Entity)dependencies.get("entity");
/* 33 */     if (entity instanceof EntityLivingBase)
/* 34 */       ((EntityLivingBase)entity).func_70690_d(new PotionEffect(MobEffects.field_76424_c, 500, 6)); 
/* 35 */     if (entity instanceof EntityLivingBase)
/* 36 */       ((EntityLivingBase)entity).func_70690_d(new PotionEffect(MobEffects.field_76420_g, 500, 6)); 
/* 37 */     if (entity instanceof EntityLivingBase)
/* 38 */       ((EntityLivingBase)entity).func_70690_d(new PotionEffect(MobEffects.field_76428_l, 500, 6)); 
/* 39 */     if (entity instanceof EntityLivingBase) {
/* 40 */       ((EntityLivingBase)entity).func_70690_d(new PotionEffect(MobEffects.field_76429_m, 500, 6));
/*    */     }
...
/* Location:              C:\Users\Administrator\Download\\urmcbetamod.jar!\net\mcreator\finfin\procedure\ProcedureNitroxinRightClickedInAir.class
