...
/*    */ import net.mcreator.finfin.procedure.ProcedureEyeSensorRightClickedInAir;
...
/*    */ 
/*    */ @Tag
/*    */ public class ItemEyeSensor
/*    */   extends ElementsFinfinMod.ModElement
/*    */ {
/*    */   @ObjectHolder("finfin:eye_sensor")
/* 29 */   public static final Item block = null;
/*    */   public ItemEyeSensor(ElementsFinfinMod instance) {
/* 31 */     super(instance, 74);
/*    */   }
/*    */ 
/*    */   
...
/* 42 */     ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("finfin:eye_sensor", "inventory"));
/*    */   }
/*    */   
/*    */   public static class ItemCustom extends Item { public ItemCustom() {
/* 46 */       func_77656_e(0);
/* 47 */       this.field_77777_bU = 1;
/* 48 */       func_77655_b("eye_sensor");
/* 49 */       setRegistryName("eye_sensor");
...
/* 78 */       ProcedureEyeSensorRightClickedInAir.executeProcedure($_dependencies);
/*    */       
/* 80 */       return ar;
/*    */     } }
/*    */ 
