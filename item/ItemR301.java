...
/*     */ 
/*     */ @Tag
/*     */ public class ItemR301 extends ElementsFinfinMod.ModElement {
/*     */   @ObjectHolder("finfin:r_301")
/*  40 */   public static final Item block = null; public static final int ENTITYID = 4;
/*     */   
/*     */   public ItemR301(ElementsFinfinMod instance) {
/*  43 */     super(instance, 80);
/*     */   }
/*     */ 
/*     */   
/*     */   public void initElements() {
/*  48 */     this.elements.items.add(() -> new RangedItem());
/*  49 */     this.elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class).id(new ResourceLocation("finfin", "entitybulletr_301"), 4).name("entitybulletr_301").tracker(64, 1, true).build());
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  56 */     ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("finfin:r_301", "inventory"));
/*     */   }
/*     */ 
/*     */   
/*     */   @SideOnly(Side.CLIENT)
...
/*     */   {
/*     */     public RangedItem() {
/*  70 */       func_77656_e(99999);
/*  71 */       func_77664_n();
/*  72 */       func_77655_b("r_301");
/*  73 */       setRegistryName("r_301");
...
/*  85 */           if (stack != null && stack.func_77973_b() == (new ItemStack(ItemR301Mermi.block, 1)).func_77973_b() && stack
/*  86 */             .func_77960_j() == (new ItemStack(ItemR301Mermi.block, 1)).func_77960_j()) {
/*  87 */             slotID = i;
/*     */             break;
/*     */           } 
/*     */         } 
...
/*     */           
/*  93 */           float power = 1.0F;
/*  94 */           ItemR301.EntityArrowCustom entityarrow = new ItemR301.EntityArrowCustom(world, (EntityLivingBase)entity);
...
/*     */               
/* 106 */               .func_82594_a(new ResourceLocation("finfin:r301fire")), SoundCategory.NEUTRAL, 1.0F, 1.0F / (field_77697_d
...
/*     */           }
/* 111 */           else if ((new ItemStack(ItemR301Mermi.block, 1)).func_77984_f()) {
...
/*     */             } 
/*     */           } else {
/* 118 */             entity.field_71071_by.func_174925_a((new ItemStack(ItemR301Mermi.block, 1)).func_77973_b(), -1, 1, null);
/*     */           } 
/*     */           
